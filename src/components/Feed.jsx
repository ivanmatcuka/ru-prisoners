const NEWS = [
  ...
  {
    headline:
      "«Я в этой драме в любом случае до финала». Выступление режиссерки Беркович и сценаристки Петрийчук на заседании по продлению ареста",
    link: "https://zona.media/article/2024/01/09/drama",
  },
  {
    headline:
      "Навального отправили в ШИЗО в колонии «Полярный волк», куда его этапировали две недели назад",
